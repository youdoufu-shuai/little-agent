...
### ⚡ 系统特性
*   **沉浸式 UI 体验**:
    *   **动态启动屏**: 带有科技感动画的 Splash Screen，无缝衔接主界面。
    *   **智能 Logo 适配**: 针对深色/浅色模式深度优化的 Logo 显示（霓虹线框 vs 饱满细节）。
    *   **流畅交互**: 打字机输出效果、Glassmorphism 玻璃拟态设计、丝滑的过渡动画。
*   **双主题系统**: 随机初始化的深色/浅色模式，支持一键热切换。
